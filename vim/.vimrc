...
nnoremap <leader>nn :call FindNextNote()<CR>
nnoremap <leader>np :call FindPreviousNote()<CR>
nnoremap <leader>no :call OpenNoteByDate()<CR>
"nnoremap <leader>no :call OpenNoteOnSpecificDay()<CR>
nnoremap <leader>ns :call SearchNotes()<CR>
