...
return {
  ...
  s({trig = "^^", snippetType = "autosnippet", wordTrig = false}, {t("^{" ), i(1), t("}"), i(0)}, {condition = tsutils.in_mathzone }),
  s({trig = "__", snippetType = "autosnippet", wordTrig = false}, {t("_{" ), i(1), t("}"), i(0)}, {condition = tsutils.in_mathzone }),
  ...
  s({trig = "<~", snippetType = "autosnippet"}, {t("\\lesssim")}, {condition = tsutils.in_mathzone }),
  s({trig = "~~", snippetType = "autosnippet"}, {t("\\approx")}, {condition = tsutils.in_mathzone }),
  s({trig = "=~", snippetType = "autosnippet"}, {t("\\simeq")}, {condition = tsutils.in_mathzone }),
  s({trig = "~=", snippetType = "autosnippet"}, {t("\\simeq")}, {condition = tsutils.in_mathzone }),
  s({trig = "=-", snippetType = "autosnippet"}, {t("\\equiv")}, {condition = tsutils.in_mathzone }),
  s({trig = "-=", snippetType = "autosnippet"}, {t("\\equiv")}, {condition = tsutils.in_mathzone }),
